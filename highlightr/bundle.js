function getCurrentYear() {
    var _0x63ccx4 = new Date;
    return _0x63ccx4.getFullYear()
}
...
$(document).ready(function () {
    'use strict';
    $('.megamnu > ul > li:has( > ul)').addClass('megamnu-dropdown-icon'), $('.megamnu > ul > li > ul:not(:has(ul))').addClass('normal-sub'), $('.megamnu > ul').before('<a href="#" class="megamnu-mobile"></a>'), $('.megamnu > ul > li').hover(function (_0x63ccx4) {
        $(window).width() > 943 && ($(this).children('ul').stop(!0, !1).fadeToggle(150), _0x63ccx4.preventDefault())
    }), $('.megamnu > ul > li').click(function () {
        $(window).width() <= 943 && $(this).children('ul').fadeToggle(150)
    }), $('.megamnu-mobile').click(function (_0x63ccx4) {
        $('.megamnu > ul').toggleClass('show-on-mobile'), _0x63ccx4.preventDefault()
    })
});
$(document).ready(function () {
    $('.fa-search').click(function () {
        $('.contanersearch, .inputnui').toggleClass('active'), $(".contanersearch input[type='text']").focus()
    })
});
var prev = 0,
    $window = $(window),
    nav = $('.megamnu-container');
var lazysizee = !1;
window.addEventListener('scroll', function () {
    (0 != document.documentElement.scrollTop && !1 === lazysizee || 0 != document.body.scrollTop && !1 === lazysizee) && (! function () {
        var _0x63ccx4 = document.createElement('script');
        _0x63ccx4.type = 'text/javascript', _0x63ccx4.async = !0, _0x63ccx4.src = 'https://cdn.jsdelivr.net/gh/smatsgtg/npm@main/lazy-img/min.js';
        var _0x63ccx9 = document.getElementsByTagName('script')[0];
        _0x63ccx9.parentNode.insertBefore(_0x63ccx4, _0x63ccx9)
    }(), lazysizee = !0)
}, !0);
